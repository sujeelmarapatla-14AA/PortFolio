...
export default function Hero() {
  return (
    <section
      id="hero"
      className="relative min-h-screen pt-28 pb-16 px-6 md:px-12 flex flex-col justify-between overflow-hidden bg-[#e5e5e7]"
    >
      ...
      <div className="w-full max-w-7xl mx-auto flex justify-end mb-8 z-20">
        <div className="flex flex-col items-end text-right max-w-md space-y-3">
          {/* Cursive Signature */}
          <span className="font-signature text-4xl md:text-5xl text-black leading-none font-bold tracking-wide">
            {name}
          </span>
          {/* Tagline */}
          ...
          <div className="relative group ml-auto z-10">
            ...
            <div className="absolute -top-16 -left-10 md:-top-20 md:-left-16 z-30 opacity-0 group-hover:opacity-100 scale-75 group-hover:scale-100 -translate-y-2 group-hover:translate-y-0 transition-all duration-500 ease-out pointer-events-none select-none">
              <div className="relative bg-white text-black border-2 border-black/90 px-5 py-3 rounded-[24px] shadow-[0_20px_40px_rgba(0,0,0,0.18)] flex items-center gap-2.5 whitespace-nowrap">
                ...
                <span className="text-xs md:text-sm font-extrabold uppercase tracking-wider text-black font-sans">
                  I&apos;m open to work — DM or Call Me! ✦
                </span>

                {/* Thought Cloud Tail Circles */}
                <div className="absolute -bottom-2.5 right-10 w-4 h-4 bg-white border-r-2 border-b-2 border-black/90 rounded-full" />
                <div className="absolute -bottom-5 right-7 w-2.5 h-2.5 bg-white border-r-2 border-b-2 border-black/90 rounded-full" />
              </div>
            </div>
